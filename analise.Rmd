...
```{r, echo=FALSE}
# grafico utilizando o comando plot do R base
# tambem são acrescentados os parâmetros pch que indica a forma dos pontos
# main para incluir o titulo, xlab e ylab para alterar a legenda dos eixos
...
plot(x=dados$Peso, y=dados$Altura, main= "Relação entre Peso e Altura", pch=18, col="blue", xlab = "Idade", ylab = "Altura", sub = "Fonte: Autoria própria", ann = TRUE)
```
