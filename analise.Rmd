...
plot(x=dados$Peso, y=dados$Altura, main= "Relação entre Peso e Altura", pch=18, col="blue", xlab = "Peso", ylab = "Altura")
```
...
plot(x=dados$Peso, y=dados$Altura, main= "Relação entre Peso e Altura", pch=17, col="green", xlab = "Peso", ylab = "Altura", sub = "Fonte: Autoria própria", ann = TRUE,
...
dados %>% 
  ...
  labs(title = "Gráfico que relaciona Idade e Altura",subtitle = "Visualização",
...
plot(x=dados$Peso, y=dados$Altura, main= "Relação entre Peso e Altura", pch=10, col="red", xlab = "Peso", ylab = "Altura")
