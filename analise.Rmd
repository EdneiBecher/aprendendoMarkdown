...
Para representar dados quantitativos estratificados por uma variável qualitativa uma alternativa interessante é utilizar boxplots.

```{r}
boxplot(Idade ~ DesempenhoMat, data = dados, frame = TRUE, names = c("Bom", "Insuficiente", "Ótimo", "Regular"), col = c("orange", "steelblue", "gray", "yellow"), xlab = "Desempenho em Matemática", ylab = "Idade", main="Boxplot que relaciona a idade com o desempenho em matemática")
```


Podemos também utilizar o ggplot2 para criar boxplots.

```{r}
ggplot(dados, aes(x=DesempenhoMat, y=Idade))+
  geom_boxplot(fill="slateblue", alpha = 0.2)+
  labs(x = "Desempenho em Matemática", title = "Desempenho em Matemática Estratificado por Idade", subtitle = "Boxplots")
```

Uma estratégia interessante pode ser ordenar os boxplots pelo valor da mediana.
